...
const item = {
  ...
  image: Startups,
  content: [
    "15+ Years of combined experience in product engineering.",
    "Built by inovators and tech community leaders who've spent years shaping the future of digital products.",
  ],
};
