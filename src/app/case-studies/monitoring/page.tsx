...
export default function IndustrialIotCaseStudy() {
    return (
        <div className="w-11/12 max-w-6xl mx-auto py-16 space-y-20">
            {/* Back link */}
            <div>
                <Link href="/#case-studies" className="inline-flex items-center text-teal-700 hover:underline text-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Furnace Monitoring</p>
                        </div>
                        <div>
                ...
                <div className="relative w-full h-72 md:h-96 rounded-xl overflow-hidden">
                    <Image src={furnaceImg} alt="Furnace IoT Case Study" fill className="object-cover" />
                </div>
            </div>
            ...
            <div className="space-y-14 text-[17px] leading-relaxed text-gray-800">
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        ...
                        <li>Azure IoT Edge compatibility limitations requiring custom D2C scripts</li>
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        ...
                        <li>OTA deployment system for software and configuration updates</li>
