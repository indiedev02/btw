...
import { Layers, SquareCheckBig, Brain, Network } from "lucide-react";
...
const Solutions = () => {
  return (
    <section id="services" className="py-20 px-6 md:px-12 lg:px-24 lg:h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight">
            Tailored Solutions.{" "}
            <span className="text-[#E7563D]">Strategic Outcomes.</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We design and deliver solutions that align with your business goals,
